/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config wrangler.jsonc` (hash: bb3bfb5b94ee12aa3e36050ee56a8831)
// Runtime types generated with workerd@1.20260601.1 2026-06-03 nodejs_compat
interface __BaseEnv_Env {
	REALTIME_EVENTS_QUEUE: Queue;
	ENVIRONMENT: "staging" | "demo" | "production" | "dev";
	SSO_SERVICE: Fetcher /* sso-api-staging */ | Fetcher /* sso-api-demo */ | Fetcher /* sso-api */ | Fetcher /* sso-api-dev */;
	REALTIME_HUB?: DurableObjectNamespace<import("./index").RealtimeHub>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		REALTIME_EVENTS_QUEUE: Queue;
		ENVIRONMENT: "staging";
		SSO_SERVICE: Fetcher /* sso-api-staging */;
	}
	interface DemoEnv {
		REALTIME_EVENTS_QUEUE: Queue;
		ENVIRONMENT: "demo";
		SSO_SERVICE: Fetcher /* sso-api-demo */;
	}
	interface ProductionEnv {
		REALTIME_EVENTS_QUEUE: Queue;
		ENVIRONMENT: "production";
		SSO_SERVICE: Fetcher /* sso-api */;
	}
